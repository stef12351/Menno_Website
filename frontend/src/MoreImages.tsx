...
const MoreImages = () => {
    ...
    return (
        // Use a green gradient background starting from the top
        <div className="min-h-screen bg-gradient-to-b from-green-50 to-white">
            <nav>
                <Navbar />
            </nav>

            {/* The hero section with "Onze Projecten" has been removed */}
                ...
                <div className="container mx-auto px-4">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {videos.map((video, index) => (
                            ...
                            >
                                <div className="aspect-w-16 aspect-h-14 relative">
